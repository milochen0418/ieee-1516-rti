...
template < class ImplementationSpecificHandleClass, class EncodedHandleClass,
	 class ImplementationSpecificHandleClassFriend, int >
	 class RTI_Handle;
...
//
//
typedef RTI_Handle< long, RTI_EncodedData, RTI_FederateHandleFactory, 1 >
    RTI_FederateHandle;
    
typedef RTI_Handle< long, RTI_EncodedData, RTI_ObjectClassHandleFactory, 2 >
    RTI_ObjectClassHandle;
    
typedef RTI_Handle< long, RTI_EncodedData, RTI_InteractionClassHandleFactory, 3 >
    RTI_InteractionClassHandle;
    
typedef RTI_Handle< long, RTI_EncodedData, RTI_ObjectInstanceHandleFactory, 4 >
    RTI_ObjectInstanceHandle;
    
typedef RTI_Handle< long, RTI_EncodedData, RTI_AttributeHandleFactory, 5 >
    RTI_AttributeHandle;
    
typedef RTI_Handle< long, RTI_EncodedData, RTI_ParameterHandleFactory, 6 >
    RTI_ParameterHandle;
    
typedef RTI_Handle< long, RTI_EncodedData, RTI_DimensionHandleFactory, 7 >
    RTI_DimensionHandle;
    
typedef RTI_Handle< long, RTI_EncodedData, RTI_MessageRetractionHandleFactory, 8 >
    RTI_MessageRetractionHandle;
    
typedef RTI_Handle< long, RTI_EncodedData, RTI_RegionHandleFactory, 11 >
    RTI_RegionHandle;
