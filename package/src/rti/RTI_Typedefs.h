...
#define RTI_set		std::set
#define RTI_map		std::map
#define RTI_vector	std::vector
#define RTI_less	std::less
#define RTI_pair	std::pair

#define RTI___STL_DEFAULT_ALLOCATOR( T )	std::allocator< T >
...
typedef RTI_map< RTI_AttributeHandle, RTI_AttributeValue, 
		RTI_less <RTI_AttributeHandle >, 
		RTI___STL_DEFAULT_ALLOCATOR (RTI_AttributeHandle) >
		RTI_AttributeHandleValueMap;

// RTI_ParameterHandleValueMap implements a constrained set of
// (parameter handle and value) pairs
typedef RTI_map< RTI_ParameterHandle, RTI_ParameterValue, 
		RTI_less<RTI_ParameterHandle >, 
		RTI___STL_DEFAULT_ALLOCATOR (RTI_ParameterHandle) >
...
typedef RTI_vector< RTI_AttributeHandleSetRegionHandleSetPair,
		RTI___STL_DEFAULT_ALLOCATOR (RTI_AttributeHandleSetRegionHandleSetPair) >
...
typedef RTI_vector< RTI_FederateHandleRestoreStatusPair,
		RTI___STL_DEFAULT_ALLOCATOR(RTI_FederateHandleRestoreStatusPair) >
