...
class RTI_Exception
{
	public:
		RTI_Exception(){};
		RTI_Exception(RTI_Exception const & rhs){ _msg = rhs._msg; };
		RTI_Exception & operator=(RTI_Exception const & rhs){ _msg = rhs._msg; return *this; };
		virtual	~RTI_Exception() throw(){};
...
#define RTI_EXCEPTION(A) \
	class A : public RTI_Exception { \
		public: \
			A(RTI_string const & message) throw(){ _msg = message; }; \
			A(A const & rhs) throw(){ _msg = rhs._msg; }; \
			A & operator = (A const & rhs) throw(){ _msg = rhs._msg; return *this; }; \
			virtual ~A() throw(){}; \
...
RTI_EXCEPTION(RTI_InternalError);
